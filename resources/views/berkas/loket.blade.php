                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="file_name" class="form-control" accept="application/pdf, image/png, image/jpeg" >
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="">Nomor Berkas</label>
                                    <input type="text" class="form-control" name="no_berkas" value="{{ $d->no_berkas }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="">Nama Pemohon</label>
                                    <input type="text" class="form-control" name="nm_pemohon" value="{{ $d->nm_pemohon }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="">Kelurahan</label>
                                    <input type="text" class="form-control" name="kelurahan" value="{{ $d->kelurahan }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="">Nomor WA</label>
                                    <input type="number" class="form-control" name="no_tlp" value="{{ $d->no_tlp }}" required>
                                </div>
                            </div>
